...
local OrionLib = {
	...
	Themes = {
		Default = {
			Main = Color3.fromRGB(243, 243, 251),
			Second = Color3.fromRGB(243, 243, 251),
			Stroke = Color3.fromRGB(243, 243, 251),
			Divider = Color3.fromRGB(243, 243, 251),
			Text = Color3.fromRGB(20, 250, 255),
			TextDark = Color3.fromRGB(243, 243, 251)
		}
	},
